    ...
    <div>
            ...
            <div class="row">
                ...
                <div class="dropdown open">
                    <button class="btn btn-secondary dropdown-toggle rounded-pill" type="button" id="triggerId" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                                Category
                            </button>
                    <div class="dropdown-menu scrollable-menu" aria-labelledby="triggerId">
                        <button class="dropdown-item" v-for="c in categories" @click="filterByCategory(c.id)">{{ c.name }}</button>
            ...
            <div class="col-1">
                <div class="dropdown open">
                    ...
                    <div class="dropdown-menu scrollable-menu" aria-labelledby="triggerId">
                        <button class="dropdown-item" v-for="m in mechanics" @click="filterByMechanic(m.id)">{{ m.name }}</button>
                        <button class="dropdown-item" href="#">Action</button>
                        <button class="dropdown-item disabled" href="#">Disabled action</button>
                    </div>
                </div>
